...
export const ZoomInIcon = ({styleClassName, handleClick})=>{
...
<g id="Complete">
    <g id="zoom-in">
      <g>
        <circle cx="10" cy="10" r="8" fill="none" stroke="var(--fullscreen-zoomin-color)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
        <line x1="21.8" y1="21.8" x2="16.2" y2="16.2" fill="none" stroke="var(--fullscreen-zoomin-color)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
        <line x1="13" y1="10" x2="7" y2="10" fill="none" stroke="var(--fullscreen-zoomin-color)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
      </g>
      <g>
        <circle cx="10.1" cy="10.1" r="8" fill="none" stroke="var(--fullscreen-zoomin-color)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
        <line x1="21.9" y1="21.9" x2="16.3" y2="16.3" fill="none" stroke="var(--fullscreen-zoomin-color)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
        <line x1="13.1" y1="10.1" x2="7.1" y2="10.1" fill="none" stroke="var(--fullscreen-zoomin-color)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
        <line x1="10" y1="13" x2="10" y2="7" fill="none" stroke="var(--fullscreen-zoomin-color)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
      </g>
    </g>
  </g>
</svg>
...
<circle cx="10.1" cy="10.1" fill="none" r="8" stroke="var(--fullscreen-zoomin-color)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>

<line fill="none" stroke="var(--fullscreen-zoomin-color)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="21.9" x2="16.3" y1="21.9" y2="16.3"/>

<line fill="none" stroke="var(--fullscreen-zoomin-color)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="13.1" x2="7.1" y1="10.1" y2="10.1"/>
...
export const CorrectIcon = ({color, handleClick, styleClassName})=>{


	console.log('cccorkir', color);
	return <svg onClick={handleClick} fill={color ? color : "var(--success-icon-color)"} className={styleClassName} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">

	<path d="M29.574 4.322L9.474 24.422l-8.358-8.357-1.116 1.116 9.474 9.474 20.1-20.1z"/>
...
// Kuliji cancel button
// <svg onClick={handleClick} className={styleClassName} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
// 	<path fill={color} d="M4.39488 3.02824L3.03024 4.39488 10.64544 12 3.02032 19.99152l1.35024 1.35024L12 13.99584l8.01408 8.01408 1.43056-1.43056-8.01408-8.01408L19.99152 3.02032 10.64544 10.64544l-1.36656-1.36656L12 10.54912z"/>
//   </svg>
...
export const PartFilledStar =({fillPercentage, starClassName})=>{
	return  <svg
...
export const CustomerStars = ({ratingNumber}) =>{
...
export const PackageReturnIcon = ({styleClassName, isDropCardIcon})=>{
    ...
    <path transform="scale(0.065)" d="M456,128.3c0-0.1,0-0.3,0-0.4c0-0.3,0-0.5-0.1-0.8c0-0.1,0-0.2,0-0.4c0-0.4-0.1-0.7-0.2-1c0-0.1-0.1-0.3-0.1-0.4
       ...
       c-0.1-0.1-0.1-0.2-0.2-0.2c-0.2-0.3-0.5-0.6-0.7-0.9c-0.1-0.1-0.1-0.1-0.2-0.2c-0.2-0.2-0.4-0.4-0.6-0.6c-0.1-0.1-0.2-0.2-0.3-0.3
       c-0.3-0.2-0.5-0.5-0.8-0.7c-0.1-0.1-0.2-0.1-0.3-0.2c-0.2-0.2-0.4-0.3-0.7-0.5c-0.1-0.1-0.2-0.1-0.4-0.2c-0.1,0-0.1-0.1-0.2-0.1
       l-199-115c-4.2-2.4-9.3-2.4-13.5,0L37.9,116.6l-0.3,0.2l0,0l0,0c0,0,0,0-0.1,0c-0.2,0.1-0.5,0.3-0.7,0.4c0,0-0.1,0-0.1,0.1
       c-0.2,0.1-0.4,0.3-0.6,0.5l-0.1,0.1c-0.2,0.2-0.4,0.3-0.6,0.5l-0.1,0.1c-0.2,0.2-0.4,0.3-0.5,0.5c-0.1,0.1-0.1,0.1-0.2,0.2
       c-0.1,0.2-0.3,0.3-0.4,0.5c-0.1,0.1-0.1,0.1-0.2,0.2c-0.1,0.2-0.3,0.3-0.4,0.5c-0.1,0.1-0.1,0.2-0.2,0.2c-0.1,0.2-0.2,0.3-0.3,0.5
       c-0.1,0.1-0.1,0.2-0.2,0.3c-0.1,0.2-0.2,0.3-0.3,0.5c0,0.1-0.1,0.2-0.1,0.2c-0.1,0.2-0.2,0.3-0.3,0.5c0,0.1-0.1,0.2-0.1,0.3
       c-0.1,0.2-0.2,0.4-0.2,0.5s-0.1,0.2-0.1,0.3c-0.1,0.2-0.1,0.3-0.2,0.5c0,0.1-0.1,0.2-0.1,0.3c-0.1,0.2-0.1,0.4-0.2,0.6
       c0,0.1,0,0.2-0.1,0.3c0,0.2-0.1,0.4-0.1,0.6c0,0.1,0,0.2,0,0.3c0,0.2-0.1,0.4-0.1,0.6c0,0.1,0,0.2,0,0.3c0,0.2,0,0.4-0.1,0.6
       c0,0.1,0,0.3,0,0.4c0,0.2,0,0.3,0,0.5l0,0l0,0v229.9c0,4.8,2.6,9.3,6.8,11.7l199.1,114.9c0,0,0.1,0,0.1,0.1c0.5,0.3,1,0.5,1.5,0.7
       h0.1c0.5,0.2,0.9,0.3,1.4,0.5c0.1,0,0.3,0.1,0.4,0.1c0.4,0.1,0.8,0.2,1.2,0.2c0.1,0,0.3,0,0.4,0.1c0.5,0.1,1.1,0.1,1.6,0.1
       c0.5,0,1.1,0,1.6-0.1c0.1,0,0.3,0,0.4-0.1c0.4-0.1,0.8-0.1,1.2-0.2c0.1,0,0.3-0.1,0.4-0.1c0.5-0.1,1-0.3,1.4-0.5h0.1
       c0.5-0.2,1-0.5,1.5-0.7c0,0,0.1,0,0.1-0.1l199.1-114.9c4.2-2.4,6.8-6.9,6.8-11.7V128.5C456,128.4,456,128.3,456,128.3z M243.4,29.1
       l172.1,99.4l-71.6,41.4L173.3,69.6L243.4,29.1z M229.9,449.9L57.8,350.5V151.8l172.1,99.4V449.9z M243.4,227.8L71.3,128.5
       l75.2-43.3l170.4,100.2L243.4,227.8z M429,350.5l-172.1,99.4V251.2l93.8-54c0.6-0.3,1.1-0.7,1.6-1.1l76.8-44.3v198.7H429z"/>
</svg>
}
