...
export const CartIcon = ({styleClassName})=>{

	

return <svg fill="var(--shopping-cart-color)" className={styleClassName} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
viewBox="0 0 483.1 483.1" xmlSpace="preserve">
<g>
...
<g id="Complete">
    <g id="zoom-in">
      <g>
        <circle cx="10" cy="10" r="8" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
        <line x1="21.8" y1="21.8" x2="16.2" y2="16.2" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
        <line x1="13" y1="10" x2="7" y2="10" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
      </g>
      <g>
        <circle cx="10.1" cy="10.1" r="8" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
        <line x1="21.9" y1="21.9" x2="16.3" y2="16.3" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
        <line x1="13.1" y1="10.1" x2="7.1" y2="10.1" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
        <line x1="10" y1="13" x2="10" y2="7" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
      </g>
    </g>
  </g>
</svg>
...
export const Stars = ({ ratingNumber, starWrapperClassName, starClassName, fillColor = 'var(--star-color)' }) => {
	...
	for (let i = 0; i < 5; i++) {
	  if (filledIndexExists && i === Math.floor(ratingNumber)) {
		stars.push(
		  <PartFilledStar key={i} starClassName={starClassName} fillPercentage={ratingNumber % 1} />
		);
	  } else {
		stars.push(
		  <Star
