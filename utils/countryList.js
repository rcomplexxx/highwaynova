export default function swapCountryCode(country) {
  ...
  const countryList = [
    ...
    { country: "Congo, the Democratic Republic of the (Kinshasa)", code: "CD" },
    { country: "Congo, Republic of the (Brazzaville)", code: "CG" },
    ...
    { country: "Côte d'Ivoire, Republic of", code: "CI" },
    ...
    { country: "French Southern and Antarctic Lands", code: "TF" },
    ...
    { country: "Macedonia, Republic of", code: "MK" },
    ...
    { country: "South Georgia and South Sandwich Islands", code: "GS" },
